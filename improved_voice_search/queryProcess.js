...
function searchOnBing(){
    ...
    //search the query
    if(search_item!==""){
        var phpRequest="search.php?query="+search_item+"&service_op=Web";                                 
...
function searchSimilarWords(base){
   var phpRequest="similarWords.php?base="+base;    
...
function searchRelateWords(base){              
    var phpRequest="relateWords.php?base="+base;                                 
...
function getSynonyms(base){
    var phpRequest="synonym.php?origin="+base;                                 
